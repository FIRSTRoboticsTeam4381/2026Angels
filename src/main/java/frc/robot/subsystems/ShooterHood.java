...
public Command joystickcontrol(Supplier<Double> joystickMove)
  ...
  public void setUp()
    ...
    hoodShootTable.put(1.5, 0.20000);//edited
    hoodShootTable.put(2.28, 0.135625);//edited
    //hoodShootTable.put(3.1, 0.224874); ignore
    hoodShootTable.put(3.8, 0.214898); //edited
    hoodShootTable.put(5.3, 0.207766); // needs a bit more editing
